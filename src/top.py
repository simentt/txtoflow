...
def main():
    ...
    # print(list(lexer.tokenize("".join(fileinput.input()))))
    # print(json.dumps(parser.parse(lexer.tokenize("".join(fileinput.input()))), indent=4))
    builder = AstBuilder(parser.parse(lexer.tokenize("".join(fileinput.input()))))
